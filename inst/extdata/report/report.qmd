...
`r get_quarto_server_version_msg(out)`
...
```{r}
#| echo: false
headers = get_quarto_server_header(out)
gt::gt(headers) |>
...
```{r}
#| echo: false
old_users = get_quarto_old_users(out)
gt::gt(old_users) |>
...
```{r}
#| echo: false
roles = get_quarto_user_roles(out)
...
```{r}
#| echo: false
sys_deps = get_quarto_sys_deps(out)
```
...
```{r}
#| echo: false
software = get_quarto_software_versions(out)
gt::gt(software) |>
